...
namespace CoddingWiki_DataAcess.Migrations
{
    ...
    [Migration("20230802102951_AddMAnytoMany_SkipMappingTable")]
    partial class AddMAnytoMany_SkipMappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.Property<int>("AuthorListAuthor_Id")
                        .HasColumnType("int");

                    b.Property<int>("BooksBookId")
                        .HasColumnType("int");

                    b.HasKey("AuthorListAuthor_Id", "BooksBookId");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("CoddingWiki_Model.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorListAuthor_Id")
